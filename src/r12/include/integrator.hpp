 ...
 * configurations
 */
double fsltrLob(int k, int qsz, int pti_sz, int lc_sz, int lci_sz, int n1, int l1, int n2, int l2,
                int n3, int l3, int n4, int l4, std::vector<double>& q_w,
                std::vector<uint8_t>& pq_dx, std::vector<double>& rk, std::vector<double>& rk_in,
