...
namespace glw {
constexpr const double GLobw2[2] = {1.0, 1.0}; // Trapezoid rule
constexpr const double GLobw3[3] = {0.333333333333333333333333333333,
                                    1.333333333333333333333333333333,
                                    0.333333333333333333333333333333};
constexpr const double GLobw4[4] = {
...
constexpr const double GLobw5[5] = {0.1, 0.544444444444444444444444444444,
                                    0.71111111111111111111111111111,
                                    0.544444444444444444444444444444, 0.1};
constexpr const double GLobw6[6] = {
    0.0666666666666666666666666666667, 0.378474956297846980316612808212,
...
constexpr const double GLobw7[7] = {
...
constexpr const double GLobw8[8] = {
...
constexpr const double GLobw9[9] = {
...
constexpr const double GLobw10[10] = {
...
double intfn::fsltrLob(int k, int qsz, int pti_sz, int lc_sz, int lci_sz,
  ...
  int p2i_i = l2 * lci_sz + n2 * pti_sz; // P(r2) inner points
  int p2p_i = l4 * lci_sz + n4 * pti_sz; // P'(r2)
  uint num_pti = 0;
  int in_idx = 0;
  double r1 = 0.0, pr2, pr2_in, chi;
  double rm1 = 0.0;
  double w_scale;
