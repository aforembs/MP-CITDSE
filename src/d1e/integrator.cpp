...
double dmx_int::tvelGL(int qsz, int lc_sz, int n1, int l1, int n2, int l2, std::vector<double>& qx,
...
double dmx_int::tlenGL(int qsz, int lc_sz, int n1, int l1, int n2, int l2, std::vector<double>& qx,
                       std::vector<double>& qw, std::vector<double>& wfn) {
  double t_ab = 0.0;
  int p1 = l1 * lc_sz + n1 * qsz;
  int p2 = l2 * lc_sz + n2 * qsz;
