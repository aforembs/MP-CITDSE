...
const double GLobx6[2] = {0.765055323929464692851002973959, 0.285231516480645096314150994041};
const double GLobx7[2] = {0.830223896278566929872032213968, 0.468848793470714213803771881909};
const double GLobx8[3] = {0.871740148509606615337445761221, 0.5917001814331423021445107314, 
                          0.20929921790247886876865726035};
const double GLobx9[3] = {0.899757995411460157312345244418, 0.677186279510737753445885427091,
                          0.363117463826178158710752068709};
const double GLobx10[4] = {0.919533908166458813828932660822, 0.73877386510550507500310617486,
                          0.477924949810444495661175092731, 0.165278957666387024626219765958};

const double *GLobx[11] = {0,0,0,0,GLobx4,GLobx5,GLobx6,GLobx7,GLobx8,GLobx9,GLobx410};

const double GLobw3[2] = {0.333333333333333333333333333333, 1.333333333333333333333333333333};
const double GLobw4[2] = {0.166666666666666666666666666667, 0.83333333333333333333333333333};
const double GLobw5[3] = {0.1, 0.544444444444444444444444444444, 0.71111111111111111111111111111};
const double GLobw6[3] = {0.0666666666666666666666666666667, 0.378474956297846980316612808212,
                          0.554858377035486353016720525121};
const double GLobw7[4] = {0.047619047619047619047619047619, 0.27682604736156594801070040629,
                          0.431745381209862623417871022281, 0.487619047619047619047619047619};
const double GLobw8[4] = {0.0357142857142857142857142857143, 0.21070422714350603938299206578,
                          0.34112269248350436476424067711, 0.4124587946587038815670529714};
const double GLobw9[5] = {0.0277777777777777777777777777778, 0.16549536156080552504633972003,
                          0.274538712500161735280705618579, 0.34642851097304634511513153214,
                          0.371519274376417233560090702948};
const double GLobw10[5] = {0.0222222222222222222222222222222, 0.133305990851070111126227170755,
                          0.224889342063126452119457821731, 0.292042683679683757875582257374,
                          0.327539761183897456656510527917,};

const double *Globw[11] = {0,0,0,GLobw3,GLobw4,GLobw5,GLobw6,GLobw7,GLobw8,GLobw9,GLobw10};
}
...
int prInner(int n, int bo, int off, int ooff, std::vector<double> &kkn,
  ...
  double max_dx = 0.0;
  for (auto i=0; i<(q_x.size()/2 + 2); ++i) {
    max_dx = std::max(std::abs(q_x[i+1]-q_x[i]),max_dx);
  }

  double min_intv = max_dx/10;
